...
var ship_templates = {
    ...
    'cyclops' : preload("res://scripts/entities/ships/cyclops.gd"),
    'medusa' : preload("res://scripts/entities/ships/medusa.gd"),
    'goliath' : preload("res://scripts/entities/ships/goliath.gd"),
    'gaia' : preload("res://scripts/entities/ships/gaia.gd"),
